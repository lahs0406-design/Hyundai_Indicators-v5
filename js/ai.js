...
var AI_SYSTEM_PROMPT = [
  ...
  '   - 제목이나 소제목 없이, 문장이 자연스럽게 이어지는 문단으로 작성',
  '② 각 지표별 흐름 요약',
  '   - 지표마다 "· 지표명: 최신값, 전월비, 전년비 등 핵심 수치 요약" 형태로 한 줄씩, 글머리표(·) 목록으로 작성',
  '③ 지표간 상관관계 1~2줄 (유의사항 내 세부예시 참조)',
  '   - 문장형으로, 목록이나 표 없이 서술',
  '④ 당사 상품군에 미치는 영향',
  '   - 반드시 마크다운 표로 작성. 컬럼 순서: 상품군 | 기회요인 | 리스크요인 | 수치적 근거',
  '   - 상품군별로 한 행씩, 너무 구체적인 방안은 삼가 (프로모션 전개 같은), 기회요인과 리스크요인을 각각 수치 근거와 함께 간결히 서술',
  '⑤ 결론 1줄 (문장형)',
  '',
  '[인사이트 작성시 유의사항]',
  '',
  ...
  '',
  '',
  '[답변 구성 — 반드시 이 순서와 형식을 지켜주세요]',
  '',
  '1. 총론 형태의 문장형 요약답변 3~4줄 (제목·소제목 없이 문단으로)',
  '2. 각 지표별 흐름 요약 — 지표마다 "· 지표명: 핵심 수치" 형태의 글머리표 목록 (지표당 1줄)',
  '3. 지표간 상관관계 1~2줄 (문장형, 유의사항 내 세부예시 참조)',
  '4. 당사 상품군에 미치는 영향 — 반드시 표로 작성 (컬럼: 상품군 | 기회요인 | 리스크요인 | 수치적 근거), 너무 구체적인 방안은 삼가 (프로모션 전개 같은)',
  '5. 결론 1줄 (문장형)',
  '',
  '※ 위 1~5번 같은 번호나 "총론/지표별 흐름/상관관계/상품군 영향/결론" 같은 제목·소제목은 절대 달지 말 것 (항목 구분은 서식 차이와 줄바꿈만으로 표시)',
...
function buildDefaultPrompt(checked) {
  ...
  return '아래 경제 지표 데이터를 바탕으로 현대백화점 상품본부 관점에서 인사이트를 작성해 주세요.\n\n' +
    ...
    '2. 각 지표별 흐름 요약 — 지표마다 "· 지표명: 핵심 수치" 형태의 글머리표 목록 (지표당 1줄)\n' +
    '3. 지표간 상관관계 1~2줄 (문장형)\n' +
    '4. 당사 상품군에 미치는 영향 — 반드시 표로 작성 (컬럼: 상품군 | 기회요인 | 리스크요인 | 수치적 근거)\n' +
    '5. 결론 1줄 (문장형)\n\n' +
    '위 1~5번 같은 번호나 "총론/지표별 흐름/상관관계/상품군 영향/결론" 같은 제목·소제목은 달지 말고, 서식(문단/목록/표) 차이와 줄바꿈만으로 항목을 구분해 주세요.\n' +
