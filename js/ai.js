...
function buildDefaultPrompt(checked) {
  ...
  return '아래 경제 지표 데이터를 바탕으로 현대백화점 상품본부 관점에서 인사이트를 작성해 주세요.\n\n' +
    '분석 지표: ' + labels.join(', ') + '\n\n' +
    '다음 구성 순서로 작성해 주세요 (시스템 프롬프트의 [답변 구성]을 그대로 따르세요):\n' +
    '- 총론 형태의 문장형 요약답변 3~4줄\n' +
    '- 각 지표별 흐름 요약 1~2줄\n' +
    '- 지표간 상관관계 1~2줄\n' +
    '- 당사 상품군에 미치는 영향 3~4줄 (기회요인/리스크요인 구분, 수치적 근거 포함, 표나 도식화 가능)\n' +
    '- 결론 1줄\n\n' +
    '제목이나 소제목, 번호 매기기 없이 문장형으로 작성하고, 모든 답변은 존대어(~입니다 등)로 작성해 주세요.\n' +
